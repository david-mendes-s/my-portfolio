  ...
  return (
      <main className="">
        <div className="flex max-md:flex-wrap  gap-6 mt-10">
          <div className="flex max-sm:flex-col max-sm:justify-center max-sm:items-center gap-6 w-1/2 bg-[#1B1B1B] max-md:w-full p-6 rounded-2xl">
          ...
          <div className="w-1/2  max-md:w-full rounded-2xl">
            ...
            <div className="flex items-center justify-center gap-6 mt-4">
              <div className="flex  flex-col justify-between gap-5 w-1/2 h-52 bg-[#1B1B1B] p-4 rounded-2xl">
