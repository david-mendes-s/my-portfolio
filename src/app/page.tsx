  ...
  return (
      <main className="">
        <div className="flex max-md:flex-wrap  gap-6 mt-10">
          <div className="flex max-sm:flex-col max-sm:justify-center max-sm:items-center gap-6 w-1/2 bg-[#1B1B1B] max-md:w-full p-6 rounded-2xl scale-up-center">
          ...
          <div className="w-1/2  max-md:w-full rounded-2xl">
            <div className="bg-[#1B1B1B] py-2 px-4 rounded-2xl scale-up-center">
              <ul className='flex flex-nowrap text-xs text-[#797979] font-bold'>
                <li className='text-white'>HABILIDADES EM: <p className='text-[#797979] inline'>HTML - CSS - JS - ReactJS</p> </li>
                
              </ul>
            </div>
            <div className="flex items-center justify-center gap-6 mt-4">
              <div className="flex  flex-col justify-between gap-5 w-1/2 h-52 bg-[#1B1B1B] p-4 rounded-2xl scale-up-center">
                    <div className='flex items-end max-lg:flex-shrink-0 w-20 h-20  rounded-2xl'>
                      <BsBuildingCheck size={35} color='#fff'/>
                    </div>
        ...
        <div className="flex max-md:flex-wrap gap-6 mt-8">
          <div className="flex w-2/5 gap-6 max-md:w-full max-md:order-2">
            ...
            <div className="flex flex-col  gap-5 w-1/2 h-52 bg-[#1B1B1B] p-4 rounded-2xl scale-up-center">
              ...
              <div className="flex flex-col gap-5 w-1/2 h-52 bg-[#1B1B1B] p-4 rounded-2xl scale-up-center">
                    <div className='flex items-end w-20 h-20 max-sm:flex-shrink-0 rounded-2xl'>
                      <BsJournalCheck size={35} color='#fff'/>
            ...
            <div className="w-3/5 max-md:w-full max-md:order-1 bg-[#1B1B1B] p-4 rounded-2xl scale-up-center">
              <div className='w-ful'>
                <ul className='flex items-center  w-full justify-center gap-6 overflow-x-hidden'>
                    <li className='flex items-end w-20 h-20  rounded-2xl'>
                      <IoLogoHtml5 size={40} color='#fff'/>
                    </li>
                    <li className='flex items-end w-20 h-20 rounded-2xl'>
                      <IoLogoCss3 size={40} color='#fff'/>
                    </li>
                    <li className='flex items-end w-20 h-20 rounded-2xl'>
                      <IoLogoJavascript size={40} color='#fff'/>
                    </li>
                    <li className='flex items-end w-20 h-20 rounded-2xl'>
                      <BiLogoReact size={40} color='#fff'/>
                    </li>
                    <li className='flex items-end w-20 h-20 rounded-2xl'>
                      <IoLogoNodejs size={40} color='#fff'/>
                    </li>
                    <li className='flex items-end w-20 h-20 rounded-2xl'>
                      <IoLogoNodejs size={40} color='#fff'/>
                    </li>
